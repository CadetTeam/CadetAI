...
const defaultVisibleApps: App[] = [
  { id: "apdgpt", name: "APD GPT", lightIcon: "/app-icons/lightFolder.png", darkIcon: "/app-icons/darkFolder.png", href: "/app", isActive: true }
]
          ...
          >
            <div className="space-y-2">
              ...
              {visibleApps.map((app) => {
                ...
                // For glassmorphic list items, use same theme icons
                  ...
                  >
                    <div className="space-y-1 max-h-60 overflow-auto">
                      {availableApps.map((app) => {
                        // Use same theme icons for popover
                        const iconSrc = resolvedTheme === 'dark' ? app.darkIcon : app.lightIcon
                        return (
                          <Button
                            key={app.id}
